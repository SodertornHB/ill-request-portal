...
{ 
    ...
    public partial class MigrationController: ControllerBase
    {
        ...
        public async Task<IActionResult> Get([FromQuery] Dictionary<string, string> filters)
        {
            ...
            var entityType = typeof(Migration);
        ...
        [HttpPost]
        public virtual async Task<IActionResult> Post([FromBody] Migration entity)
        {
        ...
        [HttpPut("{id}")]
        public virtual async Task<IActionResult> Put(int id, [FromBody] Migration entity)
        {
