...
{ 
    ...
    public partial class LogController: ControllerBase
    {
        ...
        protected readonly ILogService service;
        ...
        [HttpPost]
        public virtual async Task<IActionResult> Post([FromBody] Log entity)
        {
        ...
        [HttpPut("{id}")]
        public virtual async Task<IActionResult> Put(int id, [FromBody] Log entity)
        {
